  ...
  <form method="POST" action="/blog">
    ...
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <p class="mt-1 text-sm/6 text-gray-600">Use This form to published new post to the blog</p>
          ...
          <div class="col-span-full">
            <div class="flex gap-3">
              ...
              <div class="text-sm/6">
                ...
                <p id="published-description" class="text-gray-500">Do You Want It published Or Save It As Draft</p>
                @error('published')
                  <span class="text-red-500">{{ $message }}</span>
                @enderror
              </div>
