                    ...
                    <div class="col-span-full">
                        <div class="flex gap-3">
                            <div class="flex h-6 shrink-0 items-center">
                                <div class="group grid size-4 grid-cols-1">
                                    <input id="published" type="checkbox" name="published"
                                        value="1" {{ old('published') || (!old() && $post->published) ? 'checked' : '' }} aria-describedby="published-description" 
                            ...
                            <div class="text-sm/6">
                                ...
                                <p id="published-description" class="text-gray-500">Do You Want It published Or Save It
                                    As Draft</p>
                                @error('published')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
